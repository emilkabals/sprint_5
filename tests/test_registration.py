...
class TestRegistration:
    ...
    def test_registration_new_account_success_submit(self, driver):
        ...
        driver.find_element(*Locators.input_password).send_keys(random_password)
    ...
    def test_registration_invalid_email_format_without_at_failed_submit(self, driver):
        ...
        WebDriverWait(driver, 6).until(expected_conditions.visibility_of_element_located(Locators.button_submit))
        driver.find_element(*Locators.input_name).send_keys(UsersTestData.username)
        driver.find_element(*Locators.input_email).send_keys(f'{email_base}yandex.ru')
        driver.find_element(*Locators.input_password).send_keys(random_password)
        driver.find_element(*Locators.button_submit).click()
        assert driver.find_element(*Locators.button_submit).is_displayed()
    ...
    def test_registration_invalid_mail_format_with_invalid_domain_failed_submit(self, driver):
        ...
        WebDriverWait(driver, 6).until(expected_conditions.visibility_of_element_located(Locators.button_submit))
        driver.find_element(*Locators.input_name).send_keys(UsersTestData.username)
        driver.find_element(*Locators.input_email).send_keys(f'{email_base}@ya.')
        driver.find_element(*Locators.input_password).send_keys(random_password)
        driver.find_element(*Locators.button_submit).click()
        assert driver.find_element(*Locators.button_submit).is_displayed()
    ...
    def test_registration_valid_length_password_success_submit(self, driver, valid_password):
        ...
        driver.find_element(*Locators.input_name).send_keys(UsersTestData.username)
        driver.find_element(*Locators.input_email).send_keys(random_email)
        driver.find_element(*Locators.input_password).send_keys(valid_password)
        driver.find_element(*Locators.button_submit).click()
        WebDriverWait(driver, 6).until(expected_conditions.visibility_of_element_located(Locators.button_login))
        assert driver.find_element(*Locators.button_register).is_displayed()
    ...
    def test_registration_invalid_length_password_failed_submit(self, driver, wrong_password):
        ...
        driver.find_element(*Locators.input_name).send_keys(UsersTestData.username)
        driver.find_element(*Locators.input_email).send_keys(random_email)
        driver.find_element(*Locators.input_password).send_keys(wrong_password)
        driver.find_element(*Locators.button_submit).click()
        assert driver.find_element(*Locators.button_submit).is_displayed()
